...
echo "AnalysisNtuple/makeAnalysisNtuple ${sampleType[job]}__Dilep . ${outputdir}skims/dielectrons/V08_00_26_07/${files[job]}skim.root"
AnalysisNtuple/makeAnalysisNtuple ${sampleType[job]}__Dilep . ${outputdir}skims/dielectrons/V08_00_26_07/${files[job]}skim.root
...
echo "xrdcp -f Dilep_${files[job]}AnalysisNtuple.root ${outputdir}AnalysisNtuples_new/dielectrons/V08_00_26_07/."
xrdcp -f Dilep_${files[job]}AnalysisNtuple.root ${outputdir}AnalysisNtuples_new/dielectrons/V08_00_26_07/.
