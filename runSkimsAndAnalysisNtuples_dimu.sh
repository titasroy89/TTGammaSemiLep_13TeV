...
echo "xrdcp -f ${files[job]}skim.root ${outputdir}skims/dimuons/"
xrdcp -f ${files[job]}skim.root ${outputdir}skims/dimuons/

echo "xrdcp -f ${files[job]}AnalysisNtuple.root ${outputdir}AnalysisNtuples/dimuons/"
xrdcp -f ${files[job]}AnalysisNtuple.root ${outputdir}AnalysisNtuples/dimuons/
