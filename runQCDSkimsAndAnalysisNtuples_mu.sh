...
echo "AnalysisNtuple/makeAnalysisNtuple ${sampleType[job]}__QCDcr . ${outputdir}skims/qcdmuons/V08_00_26_07/${files[job]}skim.root"
AnalysisNtuple/makeAnalysisNtuple ${sampleType[job]}__QCDcr . ${outputdir}skims/qcdmuons/V08_00_26_07/${files[job]}skim.root
...
echo "xrdcp -f QCDcr_${files[job]}AnalysisNtuple.root ${outputdir}AnalysisNtuples_new/qcdmuons/V08_00_26_07/."
xrdcp -f QCDcr_${files[job]}AnalysisNtuple.root ${outputdir}AnalysisNtuples_new/qcdmuons/V08_00_26_07/.
