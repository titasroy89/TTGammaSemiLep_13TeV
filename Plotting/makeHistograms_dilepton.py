...
extraCutsVeryLooseCR       = "(passPresel_Mu && nJet>=2 && nBJet>=0)*"
extraPhotonCutsVeryLooseCR = "(passPresel_Mu && nJet>=2 && nBJet>=0 && %s)*"
...
if finalState=="Mu":
    sampleList[-1] = "DataMu"
    sampleList[-2] = "QCDMu"
    analysisNtupleLocation = "root://cmseos.fnal.gov//store/user/lpctop/TTGamma/13TeV_AnalysisNtuples/dimuons/V08_00_26_07/"
    outputhistName = "histograms_dilep/dimu/hists.root"
if finalState=="Ele":
...
if "VeryLoose" in sys.argv:
    print "Very Loose Control Region Select"
    nBJets = 0
    weights = "evtWeight*PUweight*muEffWeight*eleEffWeight*(btagWeight[0])"
    extraCuts = extraCutsVeryLooseCR
    extraPhotonCuts = extraPhotonCutsVeryLooseCR
    sys.argv.remove("VeryLoose")
    outputhistName = outputhistName.replace("hists.root","hists_2j0tag.root")
...
for fileName in fileList:
    tree.Add("%s/Dilep_%s"%(analysisNtupleLocation,fileName))
...
histogramInfo = [ ["jetPt[0]" , "presel_jet1Pt"   ,    [1000,0,1000], extraCuts      , ""],
                  ...
                  ["pfMET"    , "presel_MET"      ,      [290,20,600], extraCuts      , ""],
                  ["pfMETPhi" , "presel_METPhi"   , [100,-3.15,3.15], extraCuts      , ""],
                  ["nVtx"     , "presel_nVtx"     ,        [50,0,50], extraCuts      , ""],
		  ["WtransMass", "presel_WtransMass",[40,0,400],extraCuts      , ""],
		  ["DilepMass", "presel_DilepMass", [90,20,200],extraCuts      , ""],
#		  ["DilepGMass", "presel_DilepGMass", [90,20,200],extraCuts      , ""],
                  ["DilepDelR", "presel_DilepDelR", [50,0,5],extraCuts      , ""], 
                  ...
                  ["DilepMass", "phosel_DilepMass", [18,20,200],extraPhotonCuts%("phoMediumID"), ""],
		  ["WtransMass", "phosel_WtransMass",[40,0,400],extraPhotonCuts%("phoMediumID"), ""],
		#  ["DilepGMass", "phosel_DilepGMass", [18,20,200],extraPhotonCuts%("phoMediumID"), ""],
                  ["DilepDelR", "phosel_DilepDelR", [50,0,5],extraPhotonCuts%("phoMediumID"), ""],  
		  ["nVtx"     , "phosel_nVtx"     ,        [50,0,50],  extraPhotonCuts%("phoMediumID"), ""],
                  ...
                  ["dRPhotonJet"   , "phosel_dRPhotonJet"    , [200,0,4], extraPhotonCuts%("phoMediumID"), ""],
                  ["dRPhotonLepton", "phosel_dRPhotonLepton",  [200,0,6], extraPhotonCuts%("phoMediumID"), ""],
                  ["phoPhi"     , "phosel_photonPhi", [100,-3.15,3.15], extraPhotonCuts%("phoMediumID"), ""],
                  ["M3"         , "phosel_M3"       ,      [120,0,600], extraPhotonCuts%("phoMediumID"), ""],
                  ["pfMET"      , "phosel_MET"      ,      [290,20,600], extraPhotonCuts%("phoMediumID"), ""],
                  ...
                  ["phoPFChIso" , "phosel_noCut_ChIso"    ,      [300,0,20], extraPhotonCuts%("phoMediumIDPassHoverE && phoMediumIDPassSIEIE && phoMediumIDPassNeuIso && phoMediumIDPassPhoIso"), ""],
                  ["phoPFNeuIso", "phosel_noCut_NeuIso"   ,      [200,0,10], extraPhotonCuts%("phoMediumIDPassHoverE && phoMediumIDPassSIEIE && phoMediumIDPassChIso && phoMediumIDPassPhoIso"), ""],
                  ["phoPFPhoIso", "phosel_noCut_PhoIso"   ,      [100,0,20], extraPhotonCuts%("phoMediumIDPassHoverE && phoMediumIDPassSIEIE && phoMediumIDPassChIso && phoMediumIDPassNeuIso"), ""],
                  ["phoPFChIso" , "phosel_AntiSIEIE_ChIso",      [500,0,50], extraPhotonCuts%("phoMediumIDPassHoverE && !phoMediumIDPassSIEIE && phoMediumIDPassNeuIso && phoMediumIDPassPhoIso"), ""],
                  ]
